      ...
      <div className="max-w-full lg:max-w-full xl:max-w-7xl 2xl:max-w-[120rem] mx-auto">
        ...
        <div className="flex flex-col items-center justify-center mb-8 sm:mb-12 md:mb-16">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-bold font-CanelaDeck text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16 md:mb-16 lg:mb-16 xl:mb-16">
          ...
          <div className="relative">
            ...
            <div className="mt-6 lg:absolute lg:-bottom-24 lg:left-0 lg:right-0 grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="bg-blue-600 p-4 sm:p-5 md:p-6 py-6 sm:py-8 md:py-10 lg:p-6 lg:py-10 xl:p-6 xl:py-10 rounded-lg text-white shadow-lg">
                ...
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">Free +68 (025)-9875</p>
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">Free +68 (026)-9879</p>
              </div>
              ...
              <div className="bg-blue-600 p-4 sm:p-5 md:p-6 py-6 sm:py-8 md:py-10 lg:p-6 lg:py-10 xl:p-6 xl:py-10 rounded-lg text-white shadow-lg">
                ...
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">admin@example.com</p>
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">support@example.com</p>
              </div>
              ...
              >
                ...
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">427 Hall Place</p>
                <p className="text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm opacity-90 text-center font-GTAmerican">Longview, Texas</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6 mt-16 lg:mt-0">
            <div className="mb-6">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl xl:text-3xl font-bold text-gray-900 mt-2 font-CanelaDeck">Feel Free to write</h2>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 font-GTAmerican md:grid-cols-2 gap-4">
                <input
                  type="text"
                  placeholder="Enter Name"
                  className="w-full p-3 sm:p-4 font-GTAmerican lg:p-4 xl:p-4 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-GTAmerican text-sm sm:text-base"
                  value={formData.name}
                ...
                <input
                  ...
                  className="w-full p-3 sm:p-4 lg:p-4 xl:p-4 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-GTAmerican text-sm sm:text-base"
              ...
              <textarea
                ...
                rows={6}
                className="w-full p-3 sm:p-4 lg:p-4 xl:p-4 rounded-lg bg-gray-50 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-GTAmerican text-sm sm:text-base"
        ...
        <div className="flex flex-col items-center justify-center mb-8 sm:mb-12 mt-16 sm:mt-20 lg:mt-44 xl:mt-44">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            <div className="hidden sm:block w-10 md:w-16 lg:w-20 h-1 bg-blue-500"></div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-CanelaDeck lg:text-5xl xl:text-5xl 2xl:text-6xl font-bold text-center">
        ...
        <div className="mt-8 sm:mt-12">
          <div className={`rounded-lg overflow-hidden shadow-lg ${locationFocused ? 'ring-2 ring-blue-500' : ''}`}>
            ...
            <div className="w-full h-[300px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[500px] bg-gray-200 relative">
              ...
              <div className="absolute top-4 sm:top-6 md:top-8 lg:top-8 xl:top-8 left-4 sm:left-6 md:left-8 lg:left-8 xl:left-8 bg-white p-4 sm:p-5 md:p-6 lg:p-6 xl:p-6 rounded-lg shadow-lg max-w-[220px] sm:max-w-xs">
                <h3 className="font-semibold text-lg sm:text-xl lg:text-xl xl:text-xl mb-3 sm:mb-4 font-CanelaDeck">EduMon Headquarters</h3>
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-start">
                    ...
                    <p className="font-GTAmerican text-xs sm:text-sm lg:text-base xl:text-base">427 Hall Place, Longview, TX 75601, United States</p>
                  </div>
                  <div className="flex items-start">
                    <Phone className="w-4 h-4 sm:w-5 sm:h-5 lg:w-5 lg:h-5 xl:w-5 xl:h-5 text-blue-600 mr-2 sm:mr-3 mt-1 flex-shrink-0" />
                    <p className="font-GTAmerican text-xs sm:text-sm lg:text-base xl:text-base">+68 (025)-9875</p>
                  </div>
                  <div className="flex items-start">
                    <Mail className="w-4 h-4 sm:w-5 sm:h-5 lg:w-5 lg:h-5 xl:w-5 xl:h-5 text-blue-600 mr-2 sm:mr-3 mt-1 flex-shrink-0" />
                    <p className="font-GTAmerican text-xs sm:text-sm lg:text-base xl:text-base">admin@example.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-8 xl:gap-8 mt-8 sm:mt-10 md:mt-12 lg:mt-12 xl:mt-12">
            ...
            >
              ...
              <p className="text-center text-gray-600 font-GTAmerican text-sm sm:text-base lg:text-base xl:text-base">427 Hall Place, Longview, Texas</p>
            </div>
            ...
            <div className="p-4 sm:p-5 md:p-6 lg:p-6 xl:p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition-colors cursor-pointer">
              ...
              <p className="text-center text-gray-600 font-GTAmerican text-sm sm:text-base lg:text-base xl:text-base">1020 Center St, Dallas, Texas</p>
            </div>
            ...
            <div className="p-4 sm:p-5 md:p-6 lg:p-6 xl:p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition-colors cursor-pointer">
              ...
              <p className="text-center text-gray-600 font-GTAmerican text-sm sm:text-base lg:text-base xl:text-base">508 Pine St, Austin, Texas</p>
            </div>
          </div>
        </div>
      </div>
